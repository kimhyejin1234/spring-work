...
public class Board {
	...
	/*
	 ...
	 - 기존에는 생성자 혹은 setter 메서드를 통해 객체의 필드를 직접 초기화 했다면,
	 Builder 클래스를 디자인하고 활용하여 원하는 필드만 빠르게 초기화 할 수 있고,
	 코드 가독성도 뛰어나 질 수  있습니다.
	

	//1.중첨 static 클래스를 이용하여 기존 객체와 동일한 모약의 클래스를 하나 더 구축합니다.
	public static class BoardBuilder{
		...
		//필드멸 setter 메서드를 구축합니다.
		//return type 은 BorardBuilder 객체를 리턴하게끔 작성합니다.
	...
	//5.빌터 호출 메서드(Board 가 BoardBuilder 를 호출하는 메서드)

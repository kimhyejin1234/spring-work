...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>  
            ...
            <form action="${pageContext.request.contextPath}/freeboard/freeList">
		    		<div class="search-wrap">
                       ...
                       <select name="condition" class="form-control search-select">
                            ...
                            <option value="titleContent" ${pc.page.condition == 'titleCentent'?'selected':'' } >제목+내용</option>
                       </select>
                    </div>
		    </form>
    ...
    <script>
        ...
        window.onload = function(){
            ...
            //사용자가 페이지 기ㅘㄴ련 버튼을 클릭했을 때(이전,다음,1,2,3...)
            ...
            document.getElementById('pagination').addEventListener('click',e=>{
                ...
                //페이지 버튼들을 감싸고 있는 form 태그를 지목하여
                //그 안에 숨겨져 있는 input태그의 value 에
                //위에서 얻은 datga-pagenum의 값을 삽입 후 submit
